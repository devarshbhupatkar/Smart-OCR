...
f=open("E:\\Semester 4\\MiniProject\\Braille-OCR-master\\MUSOC.txt","w+")
fb=open("E:\\Semester 4\\MiniProject\\Braille-OCR-master\\BINARY.txt","w+")
...
for i in range(4):
    ...
    cv2.imwrite('E:\\Semester 4\\MiniProject\\Braille-OCR-master\\dilatedpart'+str(i)+'.jpg', dilation)
    k=cv2.imread('E:\\Semester 4\\MiniProject\\Braille-OCR-master\\dilatedpart'+str(i)+'.jpg')
    #defining the edges
    edges = cv2.Canny(k,50,150,apertureSize = 3)
    cv2.imwrite('cannyEdge'+str(i)+'.jpg',edges)
    ...
    cv2.imwrite('E:\\Semester 4\\MiniProject\\Braille-OCR-master\\hough'+str(k)+'.jpg',img)
    ...
    hough_lines=cv2.imread('E:\\Semester 4\\MiniProject\\Braille-OCR-master\\hough'+str(k)+'.jpg')
    p=[]
    ...
    for i in range(len(pxl)):
            ...
            cv2.line(pxl[i],((pxl[i].shape[1])//2,0),(((pxl[i].shape[1])//2),pxl[i].shape[0]),(0,0,255),4)
            cv2.line(pxl[i],(0,(pxl[i].shape[0])//3),(40,(pxl[i].shape[0])//3),(0,0,255),4)
            cv2.line(pxl[i],(0,(2*(pxl[i].shape[0])//3)),(40,(2*(pxl[i].shape[0])//3)),(0,0,255),4)
            cv2.imwrite('E:\\Semester 4\\MiniProject\\Braille-OCR-master\\All Characters\\character['+str(k)+']['+str(i)+'].jpg',pxl[i])
    ...
    c={'(':'011011',':':'010000', '\'':'000010','.':'010011','!':'011010','?':'011001',';':'011000',' ':'000000'}
